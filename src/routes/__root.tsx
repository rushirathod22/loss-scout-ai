...
(function(){
  try {
    var mode = localStorage.getItem('losscope:theme') || 'system';
    ...
    head: () => ({
      meta: [
        ...
        { title: "Losscope AI — Find the losses you don't see" },
        {
          name: "description",
          content:
            "AI-powered discovery of hidden operational losses in small business data.",
        },
        { name: "author", content: "Losscope AI" },
